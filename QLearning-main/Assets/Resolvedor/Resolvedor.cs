...
public class Resolvedor : MonoBehaviour {
    ...
    public void ResolverLabirinto() {
        ...
        //substituindo A* por QLearning
        Qlearning qLearning = new Qlearning(gerenciador);
        List<Node> caminho = qLearning.encontraCaminho(gerenciador.posicaoInicio, gerenciador.posicaoDestino);
